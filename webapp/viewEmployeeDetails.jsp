...
<div class="bg-animation">
    ...
    <div class="floating-icon" style="top: 40%; left: 25%; animation-delay: 9s;">🔍</div>
...
<div class="container">
    ...
    <div class="otp-info">
        An OTP will be sent to your registered mobile number: <strong><%= empPhone %></strong>
    </div>
